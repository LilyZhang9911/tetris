...
const int rotation[2][4][2] = {{{0, 0}, {-1, -1}, {-2, -2}, {-3, -3}},
                                {{0, 0}, {1, 1}, {2,2}, {3,3}}};

I::I (int level, Board *parent) : Block{level, parent, "I"}, pos {0} {
    ...
    cells[2] = parent->getCell(3,2);
    parent->getCell(3,2)->turnOn (type);

    cells [3] = parent->getCell(3,3);
    parent->getCell(3,3)->turnOn (type);
